...
export default function BalanceClientComps({
  user = {},
}: {
  ...
  const statCards = [
    {
      label: "Total Deposit",
      amount: transaction_snapshot?.total_deposit_amount || 0,
    },
    {
      label: "Total Withdraw",
      amount: transaction_snapshot?.total_withdraw_amount || 0,
    },
    {
      label: "Total Expense",
      amount: transaction_snapshot?.total_expense_amount || 0,
    },
    {
      label: "Total Invest",
      amount: transaction_snapshot?.total_investment_amount || 0,
    },
    {
      label: "Total Profit",
      amount: transaction_snapshot?.total_profit_amount || 0,
    },
    {
      label: "Total Loss",
      amount: transaction_snapshot?.total_loss_amount || 0,
    },
  ];
      ...
      >
        <Card className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-xl">
          <CardContent className="p-6">
            ...
            <p className="text-5xl mt-2 font-semibold tracking-tight">
              {transaction_snapshot?.balance + currency}
            </p>
